  ...
  const onSubmit: SubmitHandler<TLoginState> = async (data) => {
    try {
      ...
      useAuthStore.getState().login({
        ...
        userName: responseJSONData.data.userName,
        divisionName: responseJSONData.data.divisionName,
        districtName: responseJSONData.data.districtName,
        constituencyNumber: responseJSONData.data.constituencyNumber,
        constituencyName: responseJSONData.data.constituencyName,
      });
    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen w-full bg-[#0b0f19] overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col">
          <label className="text-gray-300 font-medium mb-1">MachineId</label>
          <input
            type="text"
